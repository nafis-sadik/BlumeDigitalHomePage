let musicDirectoryLoaction = "../assets/Music/";
...
const AudioPlayer = new Audio(musicDirectoryLoaction + playList[selectedMusic]);
...
$("#NextMusic").click(() => {
  ...
  console.log(musicDirectoryLoaction + playList[selectedMusic]);
  playMusic();
});
...
const playMusic = () => {
  let currentMusicTitle = playList[selectedMusic].substr(
    0,
    playList[selectedMusic].length - 4
  );
